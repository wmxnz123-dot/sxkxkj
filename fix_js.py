...
gen_content = re.sub(r"'sample': document\.getElimport re

filepath = "/Users/zhanghuimin/Down", "", gen_cowith open(filepath, 'r', encoding='utf-8') as f:
    content = f.read()

# Replace switchDrawerTa3 fix_js.py